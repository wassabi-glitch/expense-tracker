...
export function NotificationBell() {
    ...
    /** Returns colour classes for the left accent border */
    ...
    /** Small icon shown inside each notification row */
    ...
    const getTranslatedMessage = (notification) => {
        const { type, extra_data: d = {} } = notification;
    ...
    return (
        <div className="relative">
            ...
            {/* ── Dropdown panel ──────────────────────────── */}
            {isOpen && (
                <div className="absolute right-0 top-full z-50 mt-2 w-[340px] sm:w-[380px] animate-in fade-in-0 slide-in-from-top-2 duration-150">
                                    ...
                                    {notifications.map((notification) => (
                                        ...
                                        >
                                            ...
                                            <div className="flex-1 min-w-0">
                                                {/* Priority badge */}
                                                <span className={cn(
                                                    "inline-flex items-center gap-1 rounded-full px-1.5 py-0.5 text-[10px] font-semibold border mb-1",
                                                ...
                                                {/* Timestamp */}
                                                <p className="mt-1.5 text-[10px] font-medium text-muted-foreground/70 uppercase tracking-wide">
                                            ...
                                            <div className="absolute right-2 top-2 hidden group-hover:flex items-center gap-0.5 bg-background/90 rounded-md border shadow-sm p-0.5">
                                                {!notification.is_read && (
                                                    <button
