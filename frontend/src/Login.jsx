                ...
                <Card className="w-full max-w-md md:max-w-lg shadow-xl border-0 sm:border bg-white">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div className="space-y-2">
                                <div className="flex items-center justify-between">
                                    ...
                                    <a href="#" className="text-sm text-zinc-500 underline hover:text-zinc-900">
                                        Forgot password?
                                    </a>
                                </div>
                                <Input
                            ...
                            {status && (
                                <p className={`text-sm text-center mt-2 ${status === 'Success' ? 'text-green-600' : 'text-red-500'}`}>
                                    {status}
                                </p>
                            )}
                        </form>
                    ...
                    <CardFooter className="justify-center">
                        <p className="text-sm text-muted-foreground text-center">
                            ...
                            <a href="/sign-up" className="underline font-medium text-zinc-900 hover:text-zinc-700">
                                Sign up
                            </a>
                        </p>
                    </CardFooter>
