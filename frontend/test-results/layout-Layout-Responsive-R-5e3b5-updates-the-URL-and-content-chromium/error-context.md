...
- Name: layout.spec.js >> Layout Responsive & Routing >> Navigation routing updates the URL and content
- Location: e2e\layout.spec.js:56:3
...
Call log:
  - waiting for locator('a[href="/wallets"]').first()
