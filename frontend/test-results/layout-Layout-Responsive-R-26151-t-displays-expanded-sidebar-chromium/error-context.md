...
- Name: layout.spec.js >> Layout Responsive & Routing >> Desktop (lg) layout displays expanded sidebar
- Location: e2e\layout.spec.js:23:3
...
- img "Sarflog logo"
- text: Sarflog v1.0.0
- heading "Financial data infrastructure." [level=2]
- paragraph: Holat
- paragraph: Ishlayapti
- img "Sarflog logo"
