...
class Debt(Base):
    ...
    project_id = Column(Integer, ForeignKey("projects.id", ondelete="SET NULL", use_alter=True, name="fk_debt_project_id"), nullable=True)
    project_subcategory_id = Column(Integer, ForeignKey("project_subcategories.id", ondelete="SET NULL", use_alter=True, name="fk_debt_project_subcategory_id"), nullable=True)
...
class InstallmentPlan(Base):
    ...
    id = Column(Integer, primary_key=True, index=True)
    owner_id = Column(Integer, ForeignKey("users.id", ondelete="CASCADE"), nullable=False, index=True)
    debt_id = Column(Integer, ForeignKey("debts.id", ondelete="SET NULL", use_alter=True, name="fk_installment_plan_debt_id"), nullable=True)
    ...
    expense_category = Column(Enum(ExpenseCategory), nullable=True)
    expense_subcategory_id = Column(Integer, ForeignKey("user_subcategories.id", ondelete="SET NULL"), nullable=True)
    project_id = Column(Integer, ForeignKey("projects.id", ondelete="SET NULL", use_alter=True, name="fk_installment_plan_project_id"), nullable=True)
    project_subcategory_id = Column(Integer, ForeignKey("project_subcategories.id", ondelete="SET NULL", use_alter=True, name="fk_installment_plan_project_subcategory_id"), nullable=True)
