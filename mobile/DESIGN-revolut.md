...
> **Web reference only:** The breakpoints in this section describe Revolut's marketing website. They must not be imported into Sarflog mobile. The mobile source of truth is `mobile/src/layout/window-size.ts`, which follows native window-size classes.
